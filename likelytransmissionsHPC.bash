...
BlacklistInputFile="$HOME/phylotypes/JuicyClade1/DuplicateReads_surviving_InWindow_${STARTWINDOW}_to_${ENDWINDOW}.csv"
BlacklistOutputFile="$WORK/Blacklist_InWindow_${STARTWINDOW}_to_${ENDWINDOW}.csv"

# This will be created
TreeInputFile="$HOME/phylotypes/JuicyClade1/RAxML_bestTree.InWindow_${STARTWINDOW}_to_${ENDWINDOW}.tree"
TransOutputFile="$WORK/LikelyTransmissions_${STARTWINDOW}_to_${ENDWINDOW}.csv"
...
Rscript $HOME/phylotypes/LikelyTransmissions.R -f "$TreeInputFile" -o "$TransOutputFile" -r "B.FR.83.HXB2_LAI_IIIB_BRU.K03455" -p 1 -s "_" -b "$BlacklistOutputFile" -t 0.08 

rm "$BlacklistOutputFile"
cp "$TransOutputFile" $WORK
