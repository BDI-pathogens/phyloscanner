...
The source attribution methods takes `r round(mc$time,2)` hours. The convergence and mixing of the algorithm could be examined through **source.attribution.mcmc.diagnostics**.
```{r, results='hide', message=FALSE, warning=FALSE} 
