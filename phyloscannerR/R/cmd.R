...
#' @export
#' @seealso \code{cmd.phyloscanner.analyse.trees}
...
#' @param control List of input arguments to \code{phyloscanner_analyse_trees}.
#' @param valid.input.args Vector of valid input arguments.
#' @return A character string of UNIX commands.
#' @seealso \code{phyloscanner.analyse.trees}, \code{cmd.phyloscanner.analyse.trees.valid.args}
