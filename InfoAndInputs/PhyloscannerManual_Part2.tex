...
\item \c{--RDAonly}: If this option is given then only the RDA output will appear. This can be explored in \c{R} using the \c{phyloscannerR} package. It assumes \c{--outputRDA} even if that is not given, and overrides \c{--blacklistReport}, \c{--allClassifications} and \c{--collapsedTrees}
