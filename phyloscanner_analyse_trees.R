...
arg_parser$add_argument("-im", "--identifyMultifurcation", action="store_true", default=FALSE, help="If present, two hosts are classified as complex if they are in one multifurcation.")
...
identify.multifurcation  <- args$identifyMultifurcation
