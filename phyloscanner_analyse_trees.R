...
arg_parser$add_argument("-nmt", "--nMultiTrans", action="store",default=1e5, type="integer", help="Needed if allowMultiTrans. Directionality is only inferred between pairs of hosts where the number of clade from one host nested in one from the other is less than the value (default Inf).")
